...
CHOICES = [["Members", "Members"], ["Owners", "Owners"]]
...
class NotifyEmailForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        self.fields["actors"].choices = CHOICES
        self.fields["actors"].widget.choices = self.fields["actors"].choices


class NotifyEmailAction(EventAction):
    form_cls = NotifyEmailForm
    label = "Send an email to {actors}"

    def __init__(self, *args, **kwargs):
        super(NotifyEmailAction, self).__init__(*args, **kwargs)
        self.form_fields = {"actors": {"type": "mailAction", "choices": CHOICES}}
